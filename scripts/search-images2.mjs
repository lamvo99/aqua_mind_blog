...
const searches = {
  'nitrogen-cycle': ['aquarium filter bacteria biofilter', 'nitrifying bacteria aquarium filter', 'aquarium canister filter media'],
  'water-change': ['gravel vacuum aquarium', 'aquarium cleaning siphon', 'changing aquarium water'],
  'fish-food': ['fish food aquarium', 'tropical fish flakes', 'aquarium fish feeding'],
  'water-change-frequency': ['aquarium bucket water', 'water change aquarium', 'aquarium glass cleaning'],
  'budget': ['aquarium pet shop', 'fish store aquarium tanks', 'fish market aquarium'],
}
