const searches = {
  'water-change': ['aquarium pump water', 'fish tank net aquarium', 'aquarium water bucket'],
  'water-change-frequency': ['aquarium fish goldfish tank', 'home aquarium fish', 'betta fish tank'],
}
